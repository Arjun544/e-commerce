          ...
          children: [
            Obx(
              () => Checkbox(
                ...
                value: widget.cartScreenController.orderItems.contains(item)
                    ? true
                    : false,
                onChanged: (value) {
                  value == true
                      ? widget.cartScreenController.orderItems.add(item)
                      : widget.cartScreenController.orderItems.remove(item);
                },
              ),
            ),
            Expanded(
